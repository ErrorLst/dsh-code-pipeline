...
const STAGES = [
  ...
  },
  {
    ...
    description:
      "Pipeline IMPLEMENTATION stage: delegate the exact implementation of a plan to one full-tool stage subagent (it may modify the workspace). The subagent returns a summary of changes. DELEGATION RULE: after the plan is approved (in-chat gate) or the user directly asked for the change, call THIS tool — do not implement the change yourself and do not modify workspace files in the main session; even a trivial change goes through this stage. The stage model is configured in Settings → 代码流水线.",
  },
  {
    key: "review",
