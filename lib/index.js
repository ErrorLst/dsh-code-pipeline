...
const STAGE_INPUTS = {
  plan: [
    { key: "files", hint: "NEWLINE-SEPARATED list of every path the orchestrator already opened or shortlisted as relevant. The planner reads ALL of them in ONE program before it starts — pass the real list here, not only inside `context`." },
  ...
  impl: [
    { key: "files", hint: "NEWLINE-SEPARATED list of the files this workstream owns (the plan's `owned files`). The implementer reads ALL of them in ONE program before its first edit." },
  ...
  review: [
    { key: "files", hint: "NEWLINE-SEPARATED list of the changed files (plus any file the reviewer must open). The reviewer reads them in ONE program before auditing." },
